...
public class Dwarf : RaceBase
{
	...
	public Dwarf()
	{
		...
		WeaponProficiencies.Add(Equipment.Weapons.Get("Battleaxe"));
		WeaponProficiencies.Add(Equipment.Weapons.Get("Warhammer"));
		WeaponProficiencies.Add(Equipment.Weapons.Get("Handaxes"));
		WeaponProficiencies.Add(Equipment.Weapons.Get("Light Hammers"));
	}
}